...
if __name__ == "__main__":
    ...
    tuid3=contr.start_testrun("myTest3", MyStrategy1, "ETHUSDT", "KUCOIN", Interval.in_1_minute, 10000)
    contr.select_testrun(tuid3)
    time.sleep(60)
    contr.stop_testrun(tuid3)
    time.sleep(10)
    print("Starting new testrun")
    tuid4=contr.start_testrun("myTest4", MyStrategy1, "ETHUSDT", "KUCOIN", Interval.in_3_minute, 10000)
    time.sleep(190)
    contr.stop_testrun(tuid4)
    print("Waiting...")
    time.sleep(300)